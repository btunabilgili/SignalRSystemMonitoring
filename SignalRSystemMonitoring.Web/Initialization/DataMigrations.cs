...
namespace SignalRSystemMonitoring
{
    public class DataMigrations : IDataMigrations
    {
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want SignalRSystemMonitoring migrations to run on your DB.
            ...
            var migrationNamespace = "SignalRSystemMonitoring.Migrations." + databaseKey + "DB";
